...
ResourceArray = /** @class */ (function () {
    ...
    function (uri) {
        ...
        if (this.sortInfo) {
            try {
                for (var _b = tslib_1.__values(this.sortInfo), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var item = _c.value;
