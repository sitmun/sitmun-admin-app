...
import {TaskService, Task, HalOptions, HalParam} from '@app/frontend-core/src/lib/public_api';
...
export class TasksLocatorComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.columnDefs = [
      ...
      this.utils.getNonEditableColumnDef('tasksLocatorEntity.accessType', 'properties.scope'),
