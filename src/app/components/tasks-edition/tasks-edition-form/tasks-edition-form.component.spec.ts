...
import { TaskService, TerritoryService, TaskAvailabilityService, TaskGroupService, RoleService, CodeListService,ServiceService,TranslationService,ResourceService,ExternalService } from 'dist/sitmun-frontend-core/';
...
describe('TasksEditionFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [TaskService, TerritoryService, TaskGroupService, RoleService, CodeListService, TaskAvailabilityService,ServiceService,
        TranslationService,ResourceService,ExternalService,
