...
import { TaskService, TerritoryService, RoleService, CodeListService, TaskGroupService, TaskAvailabilityService,TranslationService,ResourceService,ExternalService } from 'dist/sitmun-frontend-core/';
...
describe('TasksDownloadFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [TaskService, TerritoryService, TaskGroupService, TaskAvailabilityService, RoleService, CodeListService,TranslationService,ResourceService,ExternalService,
