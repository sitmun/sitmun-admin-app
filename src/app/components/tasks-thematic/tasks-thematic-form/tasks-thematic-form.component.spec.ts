...
import { TaskService, TerritoryService, RoleService, CodeListService, TaskAvailabilityService,ResourceService } from 'dist/sitmun-frontend-core/';
...
describe('TasksThematicFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [TaskService, TerritoryService, RoleService, TaskAvailabilityService, CodeListService,ResourceService,
