...
import { TaskService, TerritoryService, RoleService, CodeListService, TaskAvailabilityService } from 'dist/sitmun-frontend-core/';
...
describe('TasksThematicFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [TaskService, TerritoryService, RoleService, TaskAvailabilityService, CodeListService,
