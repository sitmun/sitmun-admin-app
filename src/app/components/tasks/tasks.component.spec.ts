...
import { TaskService, CodeListService, TaskGroupService,TranslationService,ResourceService,ExternalService } from 'dist/sitmun-frontend-core/';
...
describe('TasksComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [TaskService,TaskGroupService, CodeListService,TranslationService,ResourceService,ExternalService, UtilsService,
