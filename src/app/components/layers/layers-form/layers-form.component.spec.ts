...
import {  CartographyService,TreeNodeService, TerritoryService, CartographyGroupService, CartographyAvailabilityService,CartographyParameterService, CodeListService  } from '@sitmun/frontend-core';
...
describe('LayersFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [CartographyService, TreeNodeService, TerritoryService, CartographyGroupService, CartographyAvailabilityService, CartographyParameterService, CodeListService,
