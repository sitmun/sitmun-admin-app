...
import { RoleService, UserService,UserConfigurationService } from 'dist/sitmun-frontend-core/';
...
describe('RoleFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [RoleService, UserService,CodeListService,UserConfigurationService,
