...
import { RoleService, UserService, CodeListService, CartographyGroupService, TerritoryService, 
  CartographyService, TaskService, UserConfigurationService, ApplicationService,ResourceService } from 'dist/sitmun-frontend-core/';
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [RoleService, UserService, TerritoryService, ApplicationService, CodeListService, 
        CartographyGroupService,UserConfigurationService, CartographyService, TaskService,ResourceService,
