...
import {
  ...
  TaskGroupService, CartographyService, TaskUIService
} from '@app/domain';
...
describe('TaskMoreInfoFormComponent', () => {
  ...
  let fixture: ComponentFixture<TaskMoreInfoFormComponent>;

  beforeAll(async () => {
    await TestBed.configureTestingModule({
      teardown: { destroyAfterEach: 0 as any },
      declarations: [TaskMoreInfoFormComponent, FormToolbarComponent],
      imports: [
        FormsModule,
        ReactiveFormsModule,
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TaskMoreInfoFormComponent);
