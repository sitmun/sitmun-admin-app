...
import { ConnectionService, CartographyService, TaskService, CodeListService,TranslationService } from 'dist/sitmun-frontend-core/';
...
describe('ConnectionFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [ConnectionService, CartographyService, TaskService, CodeListService,TranslationService,
