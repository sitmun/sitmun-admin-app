...
import { HalOptions, HalParam, TaskService, Task } from '@app/domain';
...
export class TasksEditionDataTableComponent implements OnInit {
  ...
  getAllTasksEdit = () => {
    let taskTypeID = config.tasksTypes.NUMEdition;
  ...
  newData(id: any) {
    ...
    this.router.navigate(["taskForm", id, config.tasksTypesNames.NUMEdition]);
  }
