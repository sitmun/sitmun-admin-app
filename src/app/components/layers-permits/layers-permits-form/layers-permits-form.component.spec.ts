...
import { CartographyGroupService, RoleService, CartographyService, CodeListService,TranslationService } from 'dist/sitmun-frontend-core/';
...
describe('LayersPermitsFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [CartographyGroupService, RoleService, CartographyService, CodeListService,TranslationService,
