...
import { TreeService, CodeListService,TranslationService,ResourceService } from 'dist/sitmun-frontend-core/';
...
describe('TreesComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [TreeService,CodeListService,TranslationService,ResourceService,
