...
import { TaskService, TerritoryService, RoleService, CodeListService, TaskAvailabilityService, TaskGroupService,TranslationService } from 'dist/sitmun-frontend-core/';
...
describe('TasksDocumentsFormComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [TaskService, TerritoryService, RoleService, CodeListService, TaskAvailabilityService, TaskGroupService,TranslationService,
